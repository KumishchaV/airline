...
public class AddCrewsCommand implements Command {
	
	private static final Logger log = Logger.getLogger(AddCrewsCommand.class);
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
		...
		try {
			...
			if (null == user) {
				...
				flightHasEmployee = flightHasEmployeeService.add(flightId, numberOfPilots, numberOfStewardesses, selectedEmployees);
			...
			messageAddError = "!!! Incorrect quantity of selected pilots or stewardesses !!!";

			session.setAttribute("messageAddError", messageAddError);
