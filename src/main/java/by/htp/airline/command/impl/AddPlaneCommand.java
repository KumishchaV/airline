...
public class AddPlaneCommand implements Command {
	...
	private static final Logger log = Logger.getLogger(AddPlaneCommand.class);
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
		...
		try {
			...
			if (null == user) {
				...
				planeService.add(planeType, numberOfSeats, numberOfPilots, numberOfStewardesses);

				session.setAttribute("message", "Plane is successfully added!");
